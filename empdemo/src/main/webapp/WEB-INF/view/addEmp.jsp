...
<script type="text/javascript">
    ...
    $(function () {
        $("#name").blur(function () {
            ...
            var reg = /^[\u4e00-\u9fa5]{2,4}$/;
            if(reg.test(name)){
                $(".name").attr("class","col-sm-5 name has-success");
                isName = true;
            }else {
                $(".name").attr("class","col-sm-5 name has-error");
                isName = false;
            }
        });
    });
    ...
    $(function () {
        $("#phone").blur(function () {
            ...
            if(reg.test(phone)){
                $(".phone").attr("class","col-sm-5 phone has-success");
                isPhone = true;
            }else {
                $(".phone").attr("class","col-sm-5 phone has-error");
                isPhone = false;
            }
        });
    ...
    $(function () {
        $("#salary").blur(function () {
            ...
            var reg = /^[0-9]{1,6}$/;
            if (reg.test(salary)) {
                $(".salary").attr("class", "col-sm-5 salary has-success");
                isSalary = true;
            } else {
                $(".salary").attr("class", "col-sm-5 salary has-error");
                isSalary = false;
            }
        });
